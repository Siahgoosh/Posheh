    ...
    private function seedPlans(): void
    {
        $plans = [
            [
                ...
                'panel_type' => 'solo',
                'name' => 'مشاور مستقل',
                'description' => 'پنل تک‌نفره — فایلینگ، CRM پایه، اشتراک فایل و تور ۳۶۰',
                'max_users' => 1,
                'max_properties' => 150,
                'storage_gb' => 5,
                ...
                'features' => [
                    ...
                    'property_share', 'ad_copy', 'quality_score', 'virtual_tour',
                ],
                'sort_order' => 1,
                'is_active' => true,
            ],
            [
                ...
                'panel_type' => 'office',
                'name' => 'دفتر املاک',
                'description' => 'تا ۵ مشاور — حسابداری، تیم، چت تیمی، ربات تلگرام و CRM پیشرفته',
                'max_users' => 5,
                'max_properties' => 600,
                'storage_gb' => 20,
                ...
                'features' => [
                    ...
                    'excel_export', 'pdf_export', 'jalali_calendar', 'saved_searches',
                    'property_share', 'ad_copy', 'quality_score', 'virtual_tour',
                    'lead_scoring', 'accounting', 'team', 'team_chat', 'telegram_bot',
                    'activity_logs', 'commissions', 'visit_calendar', 'owner_portal',
                ],
                'sort_order' => 2,
                'is_active' => true,
            ],
            [
                ...
                'features' => [
                    ...
                    'property_share', 'ad_copy', 'quality_score', 'virtual_tour',
                    'lead_scoring', 'accounting', 'team', 'team_chat', 'telegram_bot',
                    'whatsapp_bot', 'website_listing', 'verified_badge', 'activity_logs',
                    'content_assistant', 'advanced_analytics', 'commissions', 'visit_calendar',
