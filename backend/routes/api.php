...
use App\Http\Controllers\Api\Admin\LocalSeoAdminController;
use App\Http\Controllers\Api\Admin\ContentOpsAdminController;
use App\Http\Controllers\Api\Admin\BlogImageAdminController;
use App\Http\Controllers\Api\Admin\CroAdminController;
use App\Http\Controllers\Api\LocalSeoPublicController;
...
Route::prefix('v1')->group(function () {
    ...
    Route::get('/local/business', [LocalSeoPublicController::class, 'business']);
    Route::get('/local/locations', [LocalSeoPublicController::class, 'locations']);
    Route::get('/local/locations/{slug}', [LocalSeoPublicController::class, 'show']);
    ...
    Route::middleware(['auth:sanctum', EnsureOfficeIsActive::class, EnsureSubscriptionAccess::class])->group(function () {
        ...
        Route::prefix('admin')->middleware(EnsurePlatformStaff::class)->group(function () {
            ...
            Route::get('/seo/local', [LocalSeoAdminController::class, 'dashboard']);
            Route::post('/seo/local/bootstrap', [LocalSeoAdminController::class, 'bootstrap']);
            Route::get('/seo/local/graph', [LocalSeoAdminController::class, 'graph']);
            Route::get('/seo/local/nap-scan', [LocalSeoAdminController::class, 'napScan']);
            Route::put('/seo/local/business', [LocalSeoAdminController::class, 'updateBusiness']);
            Route::get('/seo/local/entities', [LocalSeoAdminController::class, 'entities']);
            Route::post('/seo/local/entities', [LocalSeoAdminController::class, 'storeEntity']);
            Route::post('/seo/local/relationships', [LocalSeoAdminController::class, 'relate']);
            Route::get('/seo/local/locations', [LocalSeoAdminController::class, 'locations']);
            Route::post('/seo/local/locations', [LocalSeoAdminController::class, 'storeLocation']);
            Route::put('/seo/local/locations/{id}', [LocalSeoAdminController::class, 'updateLocation']);
            Route::get('/seo/local/locations/{id}/scorecard', [LocalSeoAdminController::class, 'scorecard']);
            Route::get('/seo/local/topics', [LocalSeoAdminController::class, 'topics']);
            Route::post('/seo/local/knowledge', [LocalSeoAdminController::class, 'storeKnowledge']);
            Route::post('/seo/local/opportunities/generate', [LocalSeoAdminController::class, 'generateOpportunities']);
            Route::get('/content-ops', [ContentOpsAdminController::class, 'dashboard']);
            Route::post('/content-ops/bootstrap', [ContentOpsAdminController::class, 'bootstrap']);
            Route::get('/content-ops/usage', [ContentOpsAdminController::class, 'usage']);
            Route::get('/content-ops/providers', [ContentOpsAdminController::class, 'providers']);
            Route::get('/content-ops/pipeline', [ContentOpsAdminController::class, 'pipelineStatuses']);
            Route::get('/content-ops/jobs', [ContentOpsAdminController::class, 'jobs']);
            Route::post('/content-ops/jobs', [ContentOpsAdminController::class, 'enqueueJob'])->middleware('throttle:30,1');
            Route::post('/content-ops/jobs/process', [ContentOpsAdminController::class, 'processJobs']);
            Route::post('/content-ops/jobs/{id}/retry', [ContentOpsAdminController::class, 'retryJob']);
            Route::post('/content-ops/posts/{id}/transition', [ContentOpsAdminController::class, 'transition']);
            Route::post('/content-ops/posts/{id}/approve', [ContentOpsAdminController::class, 'approve']);
            Route::post('/content-ops/posts/{id}/request-changes', [ContentOpsAdminController::class, 'requestChanges']);
            Route::get('/content-ops/posts/{id}/publish-gate', [ContentOpsAdminController::class, 'publishGate']);
            Route::get('/content-ops/posts/{id}/comments', [ContentOpsAdminController::class, 'comments']);
            Route::get('/content-ops/claims', [ContentOpsAdminController::class, 'claims']);
            Route::post('/content-ops/claims/{id}/review', [ContentOpsAdminController::class, 'reviewClaim']);
            Route::get('/content-ops/task-configs', [ContentOpsAdminController::class, 'taskConfigs']);
            Route::put('/content-ops/task-configs/{id}', [ContentOpsAdminController::class, 'updateTaskConfig']);
            Route::get('/content-ops/cost-limits', [ContentOpsAdminController::class, 'costLimits']);
            Route::put('/content-ops/cost-limits/{id}', [ContentOpsAdminController::class, 'updateCostLimit']);
            Route::get('/content-ops/styles', [ContentOpsAdminController::class, 'styles']);
            Route::get('/content-ops/reports', [ContentOpsAdminController::class, 'reports']);
            Route::get('/blog-images', [BlogImageAdminController::class, 'dashboard']);
            Route::post('/blog-images/bootstrap', [BlogImageAdminController::class, 'bootstrap']);
            Route::post('/blog-images/audit', [BlogImageAdminController::class, 'runAudit']);
            Route::get('/blog-images/audits', [BlogImageAdminController::class, 'audits']);
            Route::post('/blog-images/dry-run', [BlogImageAdminController::class, 'dryRun']);
            Route::post('/blog-images/batches/confirm', [BlogImageAdminController::class, 'confirmBatch'])->middleware('throttle:10,1');
            Route::post('/blog-images/batches/{id}/pause', [BlogImageAdminController::class, 'pauseBatch']);
            Route::post('/blog-images/batches/{id}/resume', [BlogImageAdminController::class, 'resumeBatch']);
            Route::post('/blog-images/batches/{id}/cancel', [BlogImageAdminController::class, 'cancelBatch']);
            Route::get('/blog-images/jobs', [BlogImageAdminController::class, 'jobs']);
            Route::post('/blog-images/jobs', [BlogImageAdminController::class, 'enqueue'])->middleware('throttle:30,1');
            Route::post('/blog-images/jobs/process', [BlogImageAdminController::class, 'process']);
            Route::post('/blog-images/jobs/{id}/approve', [BlogImageAdminController::class, 'approve']);
            Route::post('/blog-images/jobs/{id}/reject', [BlogImageAdminController::class, 'reject']);
            Route::post('/blog-images/jobs/{id}/regenerate', [BlogImageAdminController::class, 'regenerate'])->middleware('throttle:20,1');
