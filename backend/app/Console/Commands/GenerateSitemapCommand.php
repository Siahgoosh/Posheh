...
class GenerateSitemapCommand extends Command
{
    ...
    protected $description = 'Generate static sitemap XML files for nginx fallback (GSC)';
    ...
    public function handle(): int
    {
        ...
        $postCount = substr_count($targets['sitemap-blog.xml'], '<url>');
        $this->info("Blog URLs in sitemap-blog.xml: {$postCount}");
