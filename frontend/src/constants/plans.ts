...
export const FALLBACK_PLANS: PlanOption[] = [
  {
    ...
    max_properties: 150,
    panel_type: 'solo',
    features: ['filing', 'crm', 'property_share', 'ad_copy', 'quality_score', 'virtual_tour'],
  },
  {
    id: 2,
    slug: 'office',
    name: 'دفتر املاک',
    description: 'تا ۵ مشاور — حسابداری، تیم، ربات تلگرام، چت تیمی و CRM پیشرفته',
    monthly_price: 990_000,
    trial_days: 0,
    max_users: 5,
    max_properties: 600,
    panel_type: 'office',
    features: ['filing', 'crm', 'accounting', 'team', 'team_chat', 'telegram_bot', 'lead_scoring', 'commissions', 'virtual_tour'],
  },
  {
    id: 3,
    slug: 'premium',
    name: 'دفتر حرفه‌ای',
    description: 'دستیار AI محتوا، سایت اختصاصی، واتساپ، تیک تأیید و تحلیل پیشرفته',
    monthly_price: 1_690_000,
    trial_days: 0,
    max_users: 10,
    max_properties: 1500,
    panel_type: 'premium',
    features: ['filing', 'crm', 'content_assistant', 'whatsapp_bot', 'website_listing', 'verified_badge', 'advanced_analytics', 'property_compare', 'team', 'team_chat', 'virtual_tour'],
  },
]
...
export const PLAN_FEATURE_LABELS: Record<string, string> = {
  ...
  content_assistant: 'دستیار هوشمند تولید محتوا (AI)',
  virtual_tour: 'تور مجازی ۳۶۰ درجه',
