  ...
  return (
    <div className="min-h-[100dvh] bg-background overflow-x-hidden">
      ...
      <main className="lg:mr-60 xl:mr-64 min-h-[100dvh] min-w-0 overflow-x-hidden">
        ...
        <div
          className="mx-auto w-full min-w-0 max-w-7xl px-3 sm:px-6 lg:px-8 pt-[calc(3.25rem+env(safe-area-inset-top))] lg:pt-8 pb-[max(1rem,env(safe-area-inset-bottom))]"
        >
